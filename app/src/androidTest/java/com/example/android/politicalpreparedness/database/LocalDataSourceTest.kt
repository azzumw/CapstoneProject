...
class LocalDataSourceTest {
    ...
    fun removeOrUnFollow_UnfollowsTheCorrectSavedElection() = runTest {
        ...
        val savedElection2RemovedResult =
            localDataSource.getSavedElectionByElectionID(savedElection2.savedElectionId)
                .getOrAwaitValue()
        val savedElection1NotRemovedResult =
            localDataSource.getSavedElectionByElectionID(savedElection1.savedElectionId)
                .getOrAwaitValue()
    ...
    fun getSavedElectionByElectionID_retrievesTheGivenSavedElection() = runTest {
        ...
        val savedElection =
            localDataSource.getSavedElectionByElectionID(election[0].id).getOrAwaitValue()
